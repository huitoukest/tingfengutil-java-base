 ...
 * @author huitoukest
 */
public class IntMixedNumber extends MixedNumber<Integer> {
     ...
     */
    public IntMixedNumber(int wholePart, int numerator, int denominator) {
        if (denominator <= 0) {
        ...
        // 如果分数部分大于等于1，转换到整数部分
        int additionalWhole = simplifiedNumerator / simplifiedDenominator;
     ...
     */
    @Override
    public Integer toImproperNumerator() {
        if (wholePart >= 0) {
     ...
     */
    @Override
    public Integer toImproperDenominator() {
        return denominator;
    }
    ...
    public boolean equals(Object obj) {
        ...
        IntMixedNumber other = (IntMixedNumber) obj;
