...
public final class TreeUtils {
    ...
    public static <T> List<T> getTreeList(List<T> list, Comparator<T> comparator) {
        ...
        return getTreeList(sortedList,
                (child, parent) -> {
                    if (parent instanceof com.tingfeng.util.java.base.collection.base.TreeNode) {
                        ((com.tingfeng.util.java.base.collection.base.TreeNode) parent).getChildren().add(child);
                    }
                },
                (child, parent) -> {
                    if (child instanceof com.tingfeng.util.java.base.collection.base.TreeNode
                            && parent instanceof com.tingfeng.util.java.base.collection.base.TreeNode) {
                        Object childParentId = ((com.tingfeng.util.java.base.collection.base.TreeNode) child).getParentId();
                        Object parentId = ((com.tingfeng.util.java.base.collection.base.TreeNode) parent).getId();
                        return childParentId != null && childParentId.equals(parentId);
                    }
                    return false;
                },
                node -> {
                    if (node instanceof com.tingfeng.util.java.base.collection.base.TreeNode) {
                        return ((com.tingfeng.util.java.base.collection.base.TreeNode) node).getId();
                    }
