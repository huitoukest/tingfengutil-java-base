...
public class RegExpUtils {
    ...
    public interface PatternStr {
        ...
        // ==================== BigNumber 相关 ====================
        /** BigInteger 格式：整数（支持正负）、十六进制(0x/0X)、八进制(0) */
        String BIGINTEGER = "^[\\-\\+]?(0[xX][0-9a-fA-F]+|0[0-7]+|[0-9]+)$";
        /** BigDecimal 格式：整数、浮点数（含正负）、科学计数法 */
        String BIGDECIMAL = "^[\\-\\+]?(0[xX][0-9a-fA-F]+|0[0-7]+|[0-9]+\\.?[0-9]*|[0-9]*\\.?[0-9]+)([eE][\\-\\+]?[0-9]+)?$";
        ...
        // ==================== 网络相关 ====================
        /**
         * 支持国际化字符的 URL (IRI) 正则表达式
         * 支持：http/https/ftp/file 协议、IPv4 地址、国际化域名 (Unicode)、端口、路径、查询字符串、片段标识符
         */
        String URL = "^(https?|ftp|file)://" +
                "(" +
                    // 选项1: IPv4 地址
                    "((25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.){3}" +
                    "(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)" +
                "|" +
                    // 选项2: 国际化域名 (允许 Unicode 字母/数字/连字符)
