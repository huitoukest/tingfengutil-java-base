...
import com.tingfeng.util.java.base.concurrent.ThreadFactoryUtils;
...
public class ThreadUtilsTest {
    ...
    public void testNewNamedThreadFactoryNotDaemon() {
        ThreadFactory factory = ThreadFactoryUtils.newNamedThreadFactory("test-thread", false);
    ...
    public void testNewNamedThreadFactoryDaemon() {
        ThreadFactory factory = ThreadFactoryUtils.newNamedThreadFactory("daemon-thread", true);
        Assert.assertNotNull("线程工厂不能为空", factory);
    ...
    public void testMultipleThreadsUniqueNames() {
        ThreadFactory factory = ThreadFactoryUtils.newNamedThreadFactory("worker", false);
    ...
    public void testThreadExecution() throws InterruptedException {
        ThreadFactory factory = ThreadFactoryUtils.newNamedThreadFactory("executor", false);
