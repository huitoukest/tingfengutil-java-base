...
public class ApiDocTest {
    static String outPath = "D:\\tmp\\javadoc\\tingfeng-java-base";
    /**
    ...
    public void testBuilderControllersApiSimple(){
        ...
        ApiDocBuilder.builderControllersApi(outPath,true);
    }
    ...
    public void testBuilderControllersApi() {
        ...
        config.setSourcePaths(
                SourcePath.path().setDesc("tingfengutil-java-base").setPath("src/main/java"),
                SourcePath.path().setPath("E:/idea_workspace/person/tingfengutil-java-base/src/main/java")
